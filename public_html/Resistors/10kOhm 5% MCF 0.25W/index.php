...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>10kOhm 5% MCF 0.25W</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">10kOhm 5% MCF 0.25W</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : RQ-103</p>
              <p class="card-text">Newark : </p>
              <p class="card-text">Category : Resistors</p>
              <p class="card-text">Cost : 0.008</p>
              ...
              <p class="card-text">Description Long : 10kOhm 5% MCF 0.25W
RQ-103
</p>
              <p class="card-text">Description Short : 10kOhm 5% MCF 0.25W
</p>
