...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>330 Ohm 5% MCF 0.25W</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">330 Ohm 5% MCF 0.25W</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : RQ-331</p>
              <p class="card-text">Newark : 28x2201</p>
              <p class="card-text">Category : Resistors</p>
              <p class="card-text">Cost : 0.006</p>
              <p class="card-text">Quantity : 10000</p>              
              <p class="card-text">Retail : 0.06</p>
              <p class="card-text">Bulk : 0.03</p>
              <p class="card-text">Jobber : 0.02</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : 330 Ohm 5% MCF 0.25W
RQ-331
28x2201
</p>
              <p class="card-text">Description Short : 330 Ohm 5% MCF 0.25W
</p>
              <p class="card-text">ISBN : </p>
              <p class="card-text">Extra1 : </p>
              <p class="card-text">Extra2 : </p>
              <p class="card-text">Extra3 : </p>
              <p class="card-text">Keyword1 : 1/4 W Resistor 5%</p>
