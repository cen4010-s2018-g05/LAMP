...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>antistatic bag - silver bag 100pcs</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">antistatic bag - silver bag 100pcs</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : as.bag-8X5</p>
              <p class="card-text">Newark : 71P4659</p>
              <p class="card-text">Category : Misc</p>
              <p class="card-text">Cost : 10.59</p>
              <p class="card-text">Quantity : 6</p>              
              <p class="card-text">Retail : 21.18</p>
              <p class="card-text">Bulk : 15.89</p>
              <p class="card-text">Jobber : 13.77</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : antistatic bag - silver bag 100pcs
as.bag-8X5
71P4659
</p>
              <p class="card-text">Description Short : antistatic bag - silver bag 100pcs</p>
              <p class="card-text">ISBN : </p>
              <p class="card-text">Extra1 : </p>
              <p class="card-text">Extra2 : </p>
              <p class="card-text">Extra3 : </p>
              <p class="card-text">Keyword1 : 8"x5" ZipLock</p>
