...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>2n2222 or PN2222 NPN Transistor, TO-92</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">2n2222 or PN2222 NPN Transistor, TO-92</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : 2N2222A</p>
              <p class="card-text">Newark : 50H5114</p>
              <p class="card-text">Category : Misc</p>
              <p class="card-text">Cost : 0.026</p>
              <p class="card-text">Quantity : 4000</p>              
              <p class="card-text">Retail : 0.26</p>
              <p class="card-text">Bulk : 0.13</p>
              <p class="card-text">Jobber : 0.07</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : 2n2222 or PN2222 NPN Transistor, TO-92
</p>
              <p class="card-text">Description Short : 2n2222 or PN2222 NPN Transistor, TO-92
</p>
