...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>TI MSP-EXP430G2 TI Launch Pad</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">TI MSP-EXP430G2 TI Launch Pad</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : MSP430-bOARD</p>
              <p class="card-text">Newark : 77R3863</p>
              <p class="card-text">Category : Misc</p>
              <p class="card-text">Cost : 10.29</p>
              <p class="card-text">Quantity : 200</p>              
              <p class="card-text">Retail : 20</p>
              <p class="card-text">Bulk : 15.44</p>
              <p class="card-text">Jobber : 13.38</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : TI MSP-EXP430G2 TI Launch Pad
MSP430-bOARD
77R3863</p>
              <p class="card-text">Description Short : TI MSP-EXP430G2 TI Launch Pad
</p>
              <p class="card-text">ISBN : </p>
              <p class="card-text">Extra1 : </p>
              <p class="card-text">Extra2 : </p>
              <p class="card-text">Extra3 : </p>
              <p class="card-text">Keyword1 : MSP430-bOARD</p>
