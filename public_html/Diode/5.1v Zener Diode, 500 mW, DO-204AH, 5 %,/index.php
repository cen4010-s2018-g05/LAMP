...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>5.1v Zener Diode, 500 mW, DO-204AH, 5 %,</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">5.1v Zener Diode, 500 mW, DO-204AH, 5 %,</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : 1n751a</p>
              <p class="card-text">Newark : 13T8945</p>
              <p class="card-text">Category : Diode</p>
              <p class="card-text">Cost : 0.019</p>
              <p class="card-text">Quantity : 2500</p>              
              <p class="card-text">Retail : 0.19</p>
              <p class="card-text">Bulk : 0.10</p>
              <p class="card-text">Jobber : .06</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : 5.1v Zener Diode, 500 mW, DO-204AH, 5 %,
1n751a
13T8945


</p>
              <p class="card-text">Description Short : 5.1v Zener Diode, 500 mW, DO-204AH, 5 %,
</p>
