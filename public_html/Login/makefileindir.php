  ...
  <body>
    ...
    <script src="vendor/bootstrap/js/bootstrap.min.js"></script>
            ...
            echo "<p>Adding ". $Product." to category " .$Category."</p>
                ...
                echo $Product." already exsists. Will update information";
                
                //saving to database
             $sql = $conn->prepare("
             UPDATE Inventory 
             SET SKU = :SKU, Newark = :Newark, Cost = :Cost, 
             Quantity = :Quantity, Descriptionshort = :Descriptionshort, Descriptionlong = :Descriptionlong, ISBN = :ISBN, Extra1 = :Extra1, Extra2 = :Extra2, Extra3 = :Extra3
            ...
            $sql = $conn->prepare("UPDATE Location SET Location1 = :Location1, Location2 = :Location2, Location3 = :Location3 WHERE Product = :Product
             ");
            $sql->bindParam(':Product', $Product);
            $sql->bindParam(':Location1', $Location1);
            $sql->bindParam(':Location2', $Location2);
...
<html lang="en">
  ...
  <body>
    ...
    <script src="vendor/bootstrap/js/bootstrap.min.js"></script>
            ...
            echo "
                <br><p>Please view here: <a href='../".$Link."/index.html'>".$Product."</a></p>";
