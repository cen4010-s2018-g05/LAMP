...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>Cap 100000000pf 100uF 107CKE035M @ 35V</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">Cap 100000000pf 100uF 107CKE035M @ 35V</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : CAP-107_35V</p>
              <p class="card-text">Newark : 69K7903</p>
              <p class="card-text">Category : Capacitor</p>
              <p class="card-text">Cost : 0.053</p>
              <p class="card-text">Quantity : 800</p>              
              <p class="card-text">Retail : 0.53</p>
              <p class="card-text">Bulk : 0.26</p>
              <p class="card-text">Jobber : 0.16</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : Cap 100000000pf 100uF 107CKE035M @ 35V
CAP-107_35V
69K7903
</p>
              <p class="card-text">Description Short : Cap 100000000pf 100uF 107CKE035M @ 35V
</p>
