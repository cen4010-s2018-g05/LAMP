...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>Cap 100000000pf 100 uF 50V Electrolytic</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">Cap 100000000pf 100 uF 50V Electrolytic</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : CAP-107_50V</p>
              <p class="card-text">Newark : 69K7856</p>
              <p class="card-text">Category : Capacitor</p>
              <p class="card-text">Cost : 0.063</p>
              <p class="card-text">Quantity : 300</p>              
              <p class="card-text">Retail : 0.63</p>
              <p class="card-text">Bulk : 0.32</p>
              <p class="card-text">Jobber : 0.19</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : Cap 100000000pf 100 uF 50V Electrolytic
CAP-107_50V
69K7856
</p>
              <p class="card-text">Description Short : Cap 100000000pf 100 uF 50V Electrolytic</p>
