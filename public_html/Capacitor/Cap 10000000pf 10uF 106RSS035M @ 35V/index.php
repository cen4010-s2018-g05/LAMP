...
<script>
 ...
 gtag("config", "UA-117910499-1");
    ...
    <title>Cap 10000000pf 10uF 106RSS035M @ 35V</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="card mt-3 mb-2">
            ...
            <div class="card-body">
              <h3 class="card-title">Cap 10000000pf 10uF 106RSS035M @ 35V</h3>
                <div class="row">
              ...
              <p class="card-text">SKU : CAP-106_35V</p>
              <p class="card-text">Newark : 55M4300</p>
              <p class="card-text">Category : Capacitor</p>
              <p class="card-text">Cost : 0.03</p>
              <p class="card-text">Quantity : 300</p>              
              <p class="card-text">Retail : 0.30</p>
              <p class="card-text">Bulk : 0.15</p>
              <p class="card-text">Jobber : 0.09</p>
              <p class="card-text">Location1 : </p>
              <p class="card-text">Location2 : </p>
              <p class="card-text">Location3 : </p>
              <p class="card-text">Description Long : Cap 10000000pf 10uF 106RSS035M @ 35V
CAP-106_35V
55M4300
</p>
              <p class="card-text">Description Short : Cap 10000000pf 10uF 106RSS035M @ 35V
</p>
